...
import type_enum.*;
import version2bis.modele.GuitarSpec;
import version2bis.modele.Inventory;
import version2bis.modele.MandolinSpec;
import version3.modele.InstrumentSpec;
...
public class Client {
    ...
    public static void initializeInventory(Inventory inventory) {
        ...
        inventory.addInstrument("34678",5500, Specification.BACKWOOD);
    }
}
